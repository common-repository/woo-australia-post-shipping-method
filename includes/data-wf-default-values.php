...
$general_settings = get_option('woocommerce_wf_australia_post_settings');
 if(empty($general_settings))
 {
	...
	$wc_main_settings['contracted_rates'] = 'yes';
	...
	$wc_main_settings['dir_download'] = 'yes';
	$wc_main_settings['email_tracking'] = 'yes';
	...
	foreach ( $this->services as $code => $values ) {
		...
		foreach ( $this->ordered_services as $value ) {
			...
			$australia_post_services[$code]['enabled'] = true;
			if ( in_array( $code, array_keys( $this->extra_cover ) ) )
			{
				$australia_post_services[ $code]['extra_cover'] =  true;
			}
			if ( in_array( $code, $this->delivery_confirmation ) )
			{
				$australia_post_services[ $code]['delivery_confirmation'] =  true;
			}
